...
SELECT * FROM (VALUES
  ...
  ('f0000000-0000-4000-8000-000000000002'::UUID, 'agent', 'zdl_governance', 'POLICY_EVALUATION', 'decisions', 'f0000000-0000-4000-8000-000000000002'::UUID, jsonb_build_object('matched_rules',NULL,'decision','deny'), now() - INTERVAL '6 hours' - INTERVAL '4 minutes'),
  ('f0000000-0000-4000-8000-000000000002'::UUID, 'agent', 'zdl_governance', 'policy_check', 'findings', 'f0000000-0000-4000-8000-000000000002'::UUID, jsonb_build_object('matched_rule_name',NULL,'decision','deny'), now() - INTERVAL '6 hours' - INTERVAL '4 minutes'),
